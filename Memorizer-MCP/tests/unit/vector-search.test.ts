...
describe('FTS5', () => {
  it('should index facts on insert via trigger', () => {
    insertFact(1, 'Alex enjoys cycling on weekends');
    insertFact(2, 'Alex works as a software engineer');
    insertFact(3, 'Alex prefers TypeScript over JavaScript');
  ...
  it('should support OR queries', () => {
    insertFact(1, 'Alex enjoys cycling on weekends');
    insertFact(2, 'Alex prefers TypeScript over JavaScript');
    insertFact(3, 'Alex lives in Warsaw');
  ...
  it('should update FTS5 on fact update via trigger', () => {
    ...
    db.prepare(
      `UPDATE facts SET fact = 'Alex enjoys swimming on weekends' WHERE id = 1`,
    ).run();
  ...
  it('should filter by agent_id with JOIN', () => {
    ...
    insertFact(2, 'Alex works as an engineer', 'main');
