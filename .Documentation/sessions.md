...
**Location:** `~/.hexa-puffs/sessions/{agentId}/{chatId}.jsonl`
...
2. **Base persona** — Loaded from `~/.hexa-puffs/agents/{agentId}/instructions.md` (tool calling rules consolidated at top)
...
Subagents get their own temporary session directories: `~/.hexa-puffs/sessions/hexa-puffs-sub-{timestamp}/`
