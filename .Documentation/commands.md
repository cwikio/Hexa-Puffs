...
- **No args:** Log file listing from `~/.hexa-puffs/logs/` with sizes and last-modified times
...
| 7 | Embedding Cache Size | `~/.hexa-puffs/data/embedding-cache.json` | info | > 10 MB |
| 8 | Memory DB Size | `~/.hexa-puffs/data/memory.db` | info | > 50 MB |

#### Logs (3 checks)

| # | Check | What | Severity | Threshold |
|---|-------|------|----------|-----------|
| 9 | Log File Sizes | Any log in `~/.hexa-puffs/logs/` too large | warning | > 50 MB per file |
...
| # | Check | What | Severity | Threshold |
|---|-------|------|----------|-----------|
| 18 | Data Directory Size | Total size of `~/.hexa-puffs/data/` | info | > 100 MB |
