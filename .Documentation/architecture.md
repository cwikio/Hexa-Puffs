...
> How the Hexa Puffs system is structured, how its components communicate, and how data flows through the stack.
...
At startup, the Orchestrator scans **sibling directories** for `package.json` files containing an `"hexa-puffs"` field:
