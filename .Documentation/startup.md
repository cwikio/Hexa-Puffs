...
| Thinker | `~/.hexa-puffs/logs/orchestrator.log` | Agent init, LLM calls, tool selection (prefixed `[thinker:hexa-puffs]`) |
...
| `Orchestrator/src/agents/agent-manager.ts` | `initializeAll()` — agent registration |
