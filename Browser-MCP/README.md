...
Headless Chromium browser automation for Hexa Puffs agents via `@playwright/mcp`.
...
Unlike every other MCP in the Hexa Puffs ecosystem, the Browser MCP does **not** use:
