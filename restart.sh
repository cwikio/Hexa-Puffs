...
# Restart the entire Hexa Puffs MCP Stack
#
# 1. Kill all Hexa Puffs processes (PID file + port cleanup)
...
echo -e "${BOLD}${CYAN}=== Restarting Hexa Puffs MCP Stack ===${RESET}\n"

# ─── Step 1: Kill all Hexa Puffs processes ─────────────────────────────────────
echo -e "${BOLD}Step 1: Killing Hexa Puffs processes${RESET}"
KILLED=0
...
sleep 1
echo -e "  ${GREEN}✓${RESET} All Hexa Puffs processes stopped"
