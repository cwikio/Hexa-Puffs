...
This document outlines the integration testing strategy for the Thinker MCP - the AI reasoning engine for the Hexa Puffs MCP ecosystem.
...
| Test | Input | Expected |
|------|-------|----------|
| Log directory exists | Check ~/.hexa-puffs/logs/ | Directory exists (or created on first use) |
