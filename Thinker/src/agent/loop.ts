 ...
 */
const DEFAULT_SYSTEM_PROMPT = `You are Hexa Puffs, a helpful AI assistant communicating via Telegram.
...
export class Agent {
  ...
  async initialize(): Promise<void> {
    ...
    // Load persona file from ~/.hexa-puffs/agents/{agentId}/instructions.md
