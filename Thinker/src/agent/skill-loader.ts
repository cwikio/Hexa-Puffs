/**
 * SkillLoader - Scans ~/.hexa-puffs/skills/ for agentskills.io-compatible SKILL.md files.
 ...
 * Hexa Puffs-specific extensions (keywords, priority, required_tools) go in the
...
export class SkillLoader {
  ...
  private async parseSkillFile(
    ...
    // Extract Hexa Puffs extensions from metadata block
