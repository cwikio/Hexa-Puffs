#!/usr/bin/env npx tsx
/**
 * Seed script for Hexa Puffs cron skills.
 *
...
// Read auth token (generated by start-all.sh, saved to ~/.hexa-puffs/hexa-puffs.token)
...
if (!HEXA_PUFFS_TOKEN) {
  try {
    ...
    console.warn('Warning: No HEXA_PUFFS_TOKEN env var and ~/.hexa-puffs/hexa-puffs.token not found. Requests may fail with 401.');
  }
}
...
Keep it concise for Telegram.`,
  ...
  },
  {
    ...
    trigger_config: { schedule: '0 6 * * *', timezone: 'UTC' }, // change to your timezone
