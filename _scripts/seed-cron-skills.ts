...
- PROJECTS: Brief status of active projects — any deadlines approaching?
...
- PROJECTS: Status of each active project — any progress or blockers?
...
Format the report:
- If no pending follow-ups: "No pending follow-ups — all caught up!"
