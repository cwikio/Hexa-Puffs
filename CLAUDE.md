...
## Scripts
- `./start-all.sh` — launch full Hexa Puffs stack (Inngest → MCPs → Orchestrator → Thinker)
...
## Auto-Discovery
New MCPs are auto-discovered at Orchestrator startup via the `"hexa-puffs"` field in `package.json`:
