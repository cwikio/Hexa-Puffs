...
describe('scanner — channel detection', () => {
  it('MCP with role: "channel" sets isChannel: true', () => {
    createMCPDir('Telegram-MCP', {
      name: 'telegram-mcp',
      main: 'dist/index.js',
      'hexa-puffs': { mcpName: 'telegram', transport: 'http', role: 'channel', httpPort: 8002 },
    });
  ...
  it('channelConfig is undefined when no channel section in manifest', () => {
    createMCPDir('Simple-Channel', {
      name: 'simple-channel',
      main: 'dist/index.js',
      'hexa-puffs': { mcpName: 'simple', role: 'channel' },
    });
  ...
  it('discovers multiple MCPs with different roles', () => {
    createMCPDir('Telegram-MCP', {
      name: 'telegram-mcp',
      main: 'dist/index.js',
      'hexa-puffs': { mcpName: 'telegram', role: 'channel', transport: 'http', httpPort: 8002 },
    });
    createMCPDir('Discord-MCP', {
      name: 'discord-mcp',
      main: 'dist/index.js',
      'hexa-puffs': { mcpName: 'discord', role: 'channel', transport: 'http', httpPort: 8003 },
    });
    createMCPDir('Guardian-MCP', {
      name: 'guardian-mcp',
      main: 'dist/index.js',
