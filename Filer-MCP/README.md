...
GRANTS_DB_PATH=~/.hexa-puffs/data/grants.json # Grants storage
AUDIT_LOG_PATH=~/.hexa-puffs/logs/fileops-audit.log
...
Log location: `~/.hexa-puffs/logs/fileops-audit.log`
