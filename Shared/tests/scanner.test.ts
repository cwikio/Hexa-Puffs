...
describe('scanForMCPs', () => {
  it('discovers an MCP with a valid hexa-puffs manifest', () => {
    createMCPDir('My-MCP', {
      name: 'my-mcp-server',
      main: 'dist/index.js',
  ...
  it('skips directories without hexa-puffs field', () => {
  ...
  it('skips hexa-puffs field without mcpName', () => {
    createMCPDir('Bad-MCP', {
      name: 'bad-mcp',
      main: 'dist/index.js',
      hexa-puffs: { transport: 'stdio' },
    });
  ...
  it('respects transport: "http" field', () => {
    createMCPDir('Searcher-MCP', {
      name: 'searcher-mcp',
      main: 'dist/index.js',
      hexa-puffs: { mcpName: 'searcher', transport: 'http', httpPort: 8007 },
    });
  ...
  it('identifies Guardian by role field', () => {
    createMCPDir('Guardian', {
      name: 'guardian-mcp',
      main: 'dist/index.js',
      hexa-puffs: { mcpName: 'guardian', role: 'guardian' },
    });
  ...
  it('respects custom sensitive and timeout values', () => {
    createMCPDir('Sensitive-MCP', {
      name: 'sensitive',
      main: 'dist/index.js',
      hexa-puffs: { mcpName: 'sensitive', sensitive: true, timeout: 60000, required: true },
    });
  ...
  it('discovers multiple MCPs in the same root', () => {
    createMCPDir('MCP-A', {
      name: 'mcp-a',
      main: 'dist/index.js',
      hexa-puffs: { mcpName: 'alpha' },
    });
    createMCPDir('MCP-B', {
      name: 'mcp-b',
      main: 'dist/index.js',
      hexa-puffs: { mcpName: 'beta', transport: 'http', httpPort: 9000 },
    });
  ...
  it('skips non-object hexa-puffs field', () => {
    createMCPDir('String-Hexa Puffs', {
      name: 'bad',
      main: 'dist/index.js',
      hexa-puffs: 'not-an-object',
    });
  ...
  describe('metadata', () => {
    ...
    it('returns undefined metadata fields when manifest omits them', () => {
      createMCPDir('Minimal-Meta', {
        name: 'minimal-meta',
        main: 'dist/index.js',
        hexa-puffs: { mcpName: 'minimal-meta' },
      });
