...
Part of the **Hexa Puffs** ecosystem. Auto-discovered by the Orchestrator on port `8007`.
...
## Hexa Puffs Integration

Auto-discovered via the `hexa-puffs` field in `package.json`:
