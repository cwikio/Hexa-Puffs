# Gmail + Calendar Enhancement — Hexa Puffs
...
- Hexa Puffs reaches the right instance based on context (contact → company → which account)
...
| agent_id | TEXT | Scoped to agent (e.g., "hexa-puffs") |
...
2. Hexa Puffs looks up **contact** by email → finds John
3. Hexa Puffs searches **projects** for John → sees 20 projects
4. Hexa Puffs searches **facts** (vector) for "John API timeline" → narrows to API Redesign
...
### Hexa Puffs's Behavior on Ambiguity
